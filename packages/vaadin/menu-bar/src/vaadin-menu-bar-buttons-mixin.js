...
export const ButtonsMixin = (superClass) =>
  class extends ResizeMixin(superClass) {
    ...
    /** @protected */
    _initButton(item) {
      const button = document.createElement('vaadin23-menu-bar-button');
    ...
    __getComponent(item) {
      ...
      if (isElement && itemComponent.localName === 'vaadin23-context-menu-item') {
        component = itemComponent;
      } else {
        component = document.createElement('vaadin23-context-menu-item');
