...
registerStyles('vaadin24-context-menu-overlay', styles, { moduleId: 'vaadin-context-menu-overlay-styles' });
...
internalCustomElements.define(ContextMenuOverlay.is, ContextMenuOverlay);
